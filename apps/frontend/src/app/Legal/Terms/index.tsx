      ...
      <Container className={styles.container}>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.content}>
            ...
            materials (information or software) on EECStime's web site for
            ...
            software contained on EECStime's web site; d) remove any
            ...
            EECStime at any time. Upon terminating your viewing of these
        ...
        <section className={styles.section}>
          ...
          <p className={styles.content}>
            The materials on EECStime's web site are provided "as is".
            EECStime makes no warranties, expressed or implied, and hereby
            disclaims and negates all other warranties, including without
            limitation, implied warranties or conditions of merchantability,
            fitness for a particular purpose, or non-infringement of
            intellectual property or other violation of rights. Further,
            EECStime does not warrant or make any representations concerning
        ...
        <section className={styles.section}>
          ...
          <p className={styles.content}>
            In no event shall EECStime or its suppliers be liable for any
            damages (including, without limitation, damages for loss of data or
            profit, or due to business interruption) arising out of the use or
            inability to use the materials on EECStime's Internet site, even
            if EECStime or an EECStime authorized representative has been
        ...
        <section className={styles.section}>
          ...
          <p className={styles.content}>
            The materials appearing on EECStime's web site could include
            technical, typographical, or photographic errors. EECStime does
            not warrant that any of the materials on its web site are accurate,
            complete, or current. EECStime may make changes to the materials
            contained on its web site at any time without notice. EECStime
        ...
        <section className={styles.section}>
          ...
          <p className={styles.content}>
            EECStime may revise these terms of use for its web site at any
        ...
        <section className={styles.section}>
          ...
          <p className={styles.content}>
            Any claim relating to EECStime's web site shall be governed by
