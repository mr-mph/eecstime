  ...
  return (
    <div className={styles.root}>
      <Container className={styles.container}>
        ...
        <p className={styles.lastUpdated}>Last updated: December 24, 2025</p>
        ...
        <section className={styles.section}>
          <h2 className={styles.heading}>Interpretation and Definitions</h2>
        ...
        <section className={styles.section}>
          ...
          <ul className={styles.list}>
            <li>
              <p className={styles.listItemContent}>Email address</p>
            </li>
            <li>
              <p className={styles.listItemContent}>First name and last name</p>
            </li>
            <li>
              <p className={styles.listItemContent}>Usage Data</p>
            </li>
          </ul>
          ...
          <ul className={styles.list}>
            <li>
              ...
              <p className={styles.listItemContent}>Type: Session Cookies</p>
              <p className={styles.listItemContent}>Administered by: Us</p>
              <p className={styles.listItemContent}>
            ...
            <li>
              ...
              <p className={styles.listItemContent}>Type: Persistent Cookies</p>
              <p className={styles.listItemContent}>Administered by: Us</p>
              <p className={styles.listItemContent}>
          ...
          <h3 className={styles.subHeading}>Transfer of Your Personal Data</h3>
          <p className={styles.content}>
          ...
          <h4 className={styles.subSubHeading}>Business Transactions</h4>
          <p className={styles.content}>
          ...
          <h4 className={styles.subSubHeading}>Law enforcement</h4>
          <p className={styles.content}>
          ...
          <h4 className={styles.subSubHeading}>Other legal requirements</h4>
          <p className={styles.content}>
          ...
          <ul className={styles.list}>
            <li>
              <p className={styles.listItemContent}>
                By email:{" "}
                <a
                  href="mailto:octo.berkeleytime@asuc.org"
                  className={styles.link}
                >
